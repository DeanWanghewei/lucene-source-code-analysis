...
abstract class DocValuesUpdate {
  ...
  static final class BinaryDocValuesUpdate extends DocValuesUpdate {
    ...
    DocValuesUpdate.BinaryDocValuesUpdate prepareForApply(int docIDUpto) {
      ...
      return new DocValuesUpdate.BinaryDocValuesUpdate(term, field, value, docIDUpto);
    }
  ...
  static final class NumericDocValuesUpdate extends DocValuesUpdate {
    ...
    DocValuesUpdate.NumericDocValuesUpdate prepareForApply(int docIDUpto) {
      ...
      return new DocValuesUpdate.NumericDocValuesUpdate(term, field, value, docIDUpto, hasValue);
    }
