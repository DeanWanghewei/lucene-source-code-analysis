  ...
  static abstract class SingleValueDocValuesFieldUpdates extends DocValuesFieldUpdates {
    ...
    DocValuesFieldUpdates.Iterator iterator() {
      ...
      return new DocValuesFieldUpdates.Iterator() {
        ...
        @Override
        long longValue() {
          return DocValuesFieldUpdates.SingleValueDocValuesFieldUpdates.this.longValue();
        }

        @Override
        BytesRef binaryValue() {
          return DocValuesFieldUpdates.SingleValueDocValuesFieldUpdates.this.binaryValue();
        }
