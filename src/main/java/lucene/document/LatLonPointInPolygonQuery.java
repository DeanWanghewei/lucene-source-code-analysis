...
import lucene.geo.GeoEncodingUtils;
import lucene.geo.Polygon;
import lucene.geo.Polygon2D;
import lucene.geo.Rectangle;
import lucene.index.FieldInfo;
import lucene.index.LeafReader;
import lucene.index.LeafReaderContext;
import lucene.index.PointValues;
import lucene.search.*;
import lucene.util.DocIdSetBuilder;
import lucene.util.FutureArrays;
import lucene.util.NumericUtils;
