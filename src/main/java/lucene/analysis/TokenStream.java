...
import lucene.analysis.tokenattributes.PackedTokenAttributeImpl;
import lucene.document.Document;
import lucene.document.Field;
import lucene.index.IndexWriter;
import lucene.util.Attribute;
import lucene.util.AttributeFactory;
import lucene.util.AttributeImpl;
import lucene.util.AttributeSource;
