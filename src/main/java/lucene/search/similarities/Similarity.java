...
import lucene.document.NumericDocValuesField;
import lucene.index.FieldInvertState;
import lucene.index.IndexWriterConfig;
import lucene.index.LeafReader;
 ...
 * be later accessible via {@link LeafReader#getNormValues(String)}.
 ...
 * accessed at query-time with {@link LeafReader#getNumericDocValues(String)}.
