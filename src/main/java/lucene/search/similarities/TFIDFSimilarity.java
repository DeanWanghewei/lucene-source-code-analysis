...
import lucene.index.FieldInvertState;
 ...
 *      {@link BoostQuery#BoostQuery(Query, float) BoostQuery}.
 *      Notice that there is really no direct API for accessing a boost of one term in a multi term query,
 *      but rather multi terms are represented in a query as multi
 *      {@link TermQuery TermQuery} objects,
 *      and so the boost of a term in the query is accessible by calling the sub-query
 *      {@link BoostQuery#getBoost() getBoost()}.
 *      <br>&nbsp;<br>
 *    </li>
 *
 *    <li>
...
public abstract class TFIDFSimilarity extends Similarity {
   ...
   * {@link IndexReader#numDocs() IndexReader#numDocs()} because also
