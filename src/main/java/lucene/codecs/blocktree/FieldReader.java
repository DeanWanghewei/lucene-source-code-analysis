 ...
 */
package lucene.codecs.blocktree;


import lucene.index.FieldInfo;
import lucene.index.IndexOptions;
import lucene.index.Terms;
import lucene.index.TermsEnum;
import lucene.store.ByteArrayDataInput;
import lucene.store.ByteBufferIndexInput;
import lucene.store.IndexInput;
import lucene.util.Accountable;
import lucene.util.Accountables;
import lucene.util.BytesRef;
import lucene.util.RamUsageEstimator;
import lucene.util.automaton.CompiledAutomaton;
import lucene.util.fst.ByteSequenceOutputs;
import lucene.util.fst.FST;
import lucene.util.fst.OffHeapFSTStore;
