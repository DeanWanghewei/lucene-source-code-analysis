...
import lucene.codecs.DocValuesFormat;
import lucene.codecs.DocValuesProducer;
import lucene.index.DocValuesType;
import lucene.index.IndexWriterConfig;
import lucene.index.SegmentReadState;
import lucene.index.SegmentWriteState;
import lucene.search.Sort;
import lucene.store.DataOutput;
import lucene.util.SmallFloat;
import lucene.util.packed.DirectWriter;
 ...
 *         using {@link IndexWriterConfig#setIndexSort(Sort) index sorting}.
 * </ul>
 * <p>
