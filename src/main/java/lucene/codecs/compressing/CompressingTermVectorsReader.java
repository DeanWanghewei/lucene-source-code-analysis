...
import lucene.codecs.TermVectorsReader;
import lucene.index.*;
import lucene.store.*;
import lucene.util.*;
import lucene.util.packed.BlockPackedReaderIterator;
...
import static org.apache.lucene.codecs.compressing.CompressingTermVectorsWriter.*;
