...
package lucene.util.graph;

import lucene.analysis.TokenStream;
import lucene.analysis.tokenattributes.BytesTermAttribute;
...
import lucene.util.IntsRef;
import lucene.util.automaton.Automaton;
import lucene.util.automaton.FiniteStringsIterator;
import lucene.util.automaton.Operations;
import lucene.util.automaton.Transition;
