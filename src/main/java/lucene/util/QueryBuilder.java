...
import lucene.analysis.Analyzer;
import lucene.analysis.CachingTokenFilter;
import lucene.analysis.TokenStream;
import lucene.analysis.tokenattributes.PositionIncrementAttribute;
import lucene.analysis.tokenattributes.PositionLengthAttribute;
import lucene.analysis.tokenattributes.TermToBytesRefAttribute;
import lucene.index.Term;
import lucene.search.*;
import lucene.search.spans.SpanNearQuery;
import lucene.search.spans.SpanOrQuery;
import lucene.search.spans.SpanQuery;
import lucene.search.spans.SpanTermQuery;
import lucene.util.graph.GraphTokenStreamFiniteStrings;
